					...
					$.ajax({
						...
						success:function(data){
							if(data!=null&&data!=""){
								/*alert(data);
								alert("**********");*/
								//$("#loginName_error").text(data.loginName_error);
...
<body>
	...
	<div class="w" id="regist">
		<div class="mt">
			...
			<span>我已经注册，现在就&nbsp;<a href="tologin">登录</a></span>
		</div>
		<div class="mc">
			<ul class="tab">
			...
			<form id="registerform" method="post" name="registerform" action="${ctx}/register.action">
			    ...
			    <div class="form">
			        ...
			        <div class="item">
			            ...
			            <div class="fl">
			                <input type="text" id="loginName" name="loginName" value="${requestScope.registerUser.loginName}"
			                class="text" 
			        ...
			        <div class="item">
			            ...
			            <div class="fl">
							...
							class="text" value="${requestScope.registerUser.passWord}"
							onfocus="formOnfocus(this.id);" onblur="formOnblur(this.id);">
					...
					<div class="item">
			            ...
			            <div class="fl">
			                <input type="text" id="userName" name="name" value="${requestScope.registerUser.name}"
			                class="text" 
							onfocus="formOnfocus(this.id);" onblur="formOnblur(this.id);">
					...
					<div class="item">
			            ...
			            <div class="fl">
			                <input type="text" id="address" name="address" value="${requestScope.registerUser.address}"
			                class="text"
							onfocus="formOnfocus(this.id);" onblur="formOnblur(this.id);">
					...
					<div class="item">
			            ...
			            <div class="fl">
			                <input type="text" id="phone" name="phone" value="${requestScope.registerUser.phone}"
			                class="text" 
							onfocus="formOnfocus(this.id);" onblur="formOnblur(this.id);"/>
