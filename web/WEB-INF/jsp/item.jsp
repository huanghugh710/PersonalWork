			...
			function numFun(flag){
				...
				switch(flag){
				 case 1:
					 ...
					 buyNum.value = (buyNumVal<=0) ? 1 : buyNumVal-1;
					 break;
					 
				 case 2:
					 buyNum.value = buyNumVal+1;
					 break;
			...
			<div class="w960 center">
				<ul>
					...
					<c:forEach items="${maps}" var="map">
					   <li><a title="${map.value}" href="${pageContext.request.contextPath}/index.action?typeCode=${map.key}">${map.value}</a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
			...
			<div class="right-extra">
				...
				<ul id="book-price">
					...
					<li><font color="red">疯&nbsp;&nbsp;狂&nbsp;&nbsp;价：</font><span id="priceinfo"
						class="price">￥${article.discountPrice }</span><span class="rate" id="pricediscount">（7.6折）</span></li>
					<li class="sub">
