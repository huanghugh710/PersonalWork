					...
					<div class="login_frame_border">
						<div class="login_frame">
							<div class="login_title">
								<font color="red">${message}</font>还不是商城用户？&nbsp;&nbsp;<a href="toRegister">立即注册</a>
							</div>
							<div class="login_frist clearfix" id="user_div_name">
								<label>登录名</label> 
								<span class="login_input"> 
									<input name="loginName" value="${loginName}" type="text" maxlength="40" id="loginName" class="tip" required/>
								</span> 
							...
							<p class="clearfix" id="password_div">
								<label>密&nbsp;&nbsp;码</label> 
								<span class="login_input">
									<input name="passWord" value="${passWord}" type="passWord" maxlength="20" id="passWord" required/>
								</span> 
