...
function header(name){
	...
	str += "			<a title=\"www.yueqian.com.cn\" href=\"http://www.yueqian.com.cn\">www.yueqian.com.cn</a>";
	str += "		</span>";
	str += "	</li>";
	str += "</ul>";
	str += "<ul class=\"fr lh\">";
	...
	str += "			<a href=\"javascript:window.external.addFavorite('http://www.yueqian.com.cn','粤嵌软件教育-购物商城');\">加入收藏</a>";
	str += "		</span>";
	str += "	</li>";
	str += "</ul>";
	str += "</div>";
	...
	str += "		<a href=\"toIndex\" title=\"粤嵌软件教育-购物商城\"><img alt=\"粤嵌软件教育-购物商城\" src=\"images/logo.gif\"></a>";
	str += "	</h1>";
	str += "</div>";
	str += "<div class=\"banner\">";
	str += "	<a title=\"粤嵌软件教育-购物商城2\" href=\"javascript:void(0);\"></a>";
	str += "	<a title=\"粤嵌软件教育-购物商城2\" href=\"toIndex\">";
	str += "	<em>";
	str += "	<img height=\"80\" width=\"552\" alt=\"粤嵌软件教育-购物商城2\" border=\"0\" src=\"images/banner.gif\">";
	str += "	</em></a>";
	str += "</div>";
	str += "<div class=\"rlink\">";
	str += "	<ul>";
